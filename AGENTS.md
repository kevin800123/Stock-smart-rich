...
平日 21:40「今日新進榜」（✦／NEW 分兩段）、週六 18:00「本週新進榜」＋本週大戶買進前三子產業（大戶資料週更，
...
佔 83%。第一列：≥1641 前 30 佔 7（兩欄 1–15／16–30）＋保證金 5；1181–1640 前 30 佔 5（單欄）
＋保證金 7；≤1180 單欄。高度由前 30 決定，保證金 `flex:1 1 0; min-height:300px` 填滿（6＋6 在
...
日子頂替）；前端兩張 `table-layout:fixed` 表，具名容器 `ssf-hot` ≥660px 並排；成交量長度條只寫
