...
def test_public_overview_shares_internal_frontend(tmp_path, monkeypatch):
    ...
    assert 'src="/app.js?v=20260817-ui13"' in html.text
    assert 'href="/styles.css?v=20260817-ui13"' in html.text
    assert 'src="app.js?v=20260817-ui13"' not in html.text
    assert 'href="styles.css?v=20260817-ui13"' not in html.text
